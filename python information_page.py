...
Label(root, text="Inventory System", font=("Harlow solid italic", 20), width=28, fg='black', bg='#870006').place(x=300,
                                                                                                              y=60)
Label(root, text="Name: Dhruv Kapadia", font=("Harlow solid italic", 15)).place(x=300, y=120)
Label(root, text="Enroll No: ABC    ", font=("New Times Roman", 15)).place(x=300, y=150)
